...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet"
	href="${contextPath}/css/terms.css" />
<link rel="stylesheet"
...
<body>
	...
	<div class="main-container">
		...
		<div class="section-block">
			...
			<ul>
				...
				<li><strong>Company</strong>(referred to as either "the
					...
					Rest Furnitures Pvt. Ltd., Bouddhanath, Kathmandu.</li>
				...
				<li><strong>Terms and Conditions</strong> (also referred as
					...
					the help of the Terms and Conditions Generator.</li>
				...
				<li><strong>Websites</strong>refers to Nest and Rest,
					accessible from https://nestandrest.com.np</li>
				<li><strong>You</strong> means the individual accessing or
		...
		<div class="section-block">
			...
			<p>By accessing or using the Service You agree to be bound by
				these Terms and Conditions. If You disagree with any part of these
				Terms and Conditions then You may not access the Service.</p>
			<p>You represent that you are over the age of 18. The Company
				does not permit those under 18 to use the Service.</p>
		...
		<div class="section-block">
			...
			<p>Some states do not allow the exclusion of implied warranties
		...
		<div class="section-block">
			...
			<p>If You have any concern or dispute about the Service, You
				agree to first try to resolve the dispute informally by contacting
				the Company.</p>
		</div>
		<div class="section-block">
			<h3>For European Union (EU) Users</h3>
			<p>If You are a European Union consumer, you will benefit from
		...
		<div class="section-block">
			...
			<h5>Waiver</h5>
			<p>Except as provided herein, the failure to exercise a right or
		...
		<div class="section-block">
			...
			<p>These Terms and Conditions may have been translated if We have
				...
				original English text shall prevail in the case of a dispute.</p>
		</div>
		...
		<div class="section-block">
			...
			<p>
				...
				contact us by email: <a href="mailto:contact@nestandrest.com.np">contact@nestandrest.com.np</a>
			</p>
		</div>
