...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/privacy-policy.css" />
</head>
</head>
<body>
	...
	<main class="container">
		...
		<p class="muted">Last updated: April 05, 2025</p>
		...
		<p>
			...
			in accordance with the help of the <a
				href="https://www.freeprivacypolicy.com/" target="_blank"><u>Free
					Privacy Policy</u></a>
		</p>
		...
		<ol>
			...
			<li><strong>Company</strong> (referred to as either "the
				Company", "We", "Us" or "Our" in this Agreement) refers to Nest And
				Rest Furnitures, Boudhanath.</li>
			<li><strong>Device</strong> means any device that can access the
				Service such as a computer, cellphone, or digital tablet.</li>
			<li><strong>Service</strong> refers to the Website.</li>
			<li><strong>Terms and Conditions</strong> (also referred to as
				"Terms") means these Terms and Conditions that form the entire
				...
				the help of the<a href="" target="_blank"> <u> Terms and
						Conditions Generator</u></a>.</li>
			...
			<li><strong>Website</strong> refers to Nest and Rest, accessible
				from <a href="https://nestandrest.com.np" target="_blank">https://nestandrest.com.np</a></li>
		...
		<ol>
			...
			<li><strong>To provide You</strong> with news, special offers,
				...
				such information.</li>
			<li><strong>To manage Your requests</strong>: To attend and
			...
			<li><strong>For other purposes</strong>: such as data analysis,
		...
		<p>We may share Your personal information in the following
			situations:</p>
		<ol>
			<li><strong>With Service Providers:</strong> To monitor and
				analyze the use of our Service.</li>
			<li><strong>For business transfers:</strong> In connection with
				or during negotiations of any merger, sale of assets, or
				acquisition.</li>
			<li><strong>With Affiliates:</strong> Our affiliates will honor
				this Privacy Policy.</li>
			<li><strong>With business partners:</strong> To offer You
				certain products, services, or promotions.</li>
			<li><strong>With other users:</strong> When You share personal
				information publicly, it may be seen and used by others.</li>
			<li><strong>With Your consent:</strong> For any other purpose
				with Your consent.</li>
		</ol>

		<h4>Retention of Your Personal Data</h4>
		<p>The Company will retain Your Personal Data only as long as
			necessary for the purposes set out in this Privacy Policy. We may
			retain Usage Data for internal analysis purposes or when required by
			law.</p>

		<h4>Transfer of Your Personal Data</h4>
		<p>Your information may be transferred to and maintained on
			computers located outside of Your jurisdiction where the data
		...
		<p>We will ensure that Your data is treated securely and in
		...
		<p>You have the right to request deletion of the Personal Data
			that We have collected about You. You may do so via account settings
			or by contacting Us.</p>
		<p>Note that We may retain certain information when legally
			required.</p>

		<h4>Changes to this Privacy Policy</h4>
		<p>We may update Our Privacy Policy from time to time and will
			notify You of any changes by posting the new version on this page.
			Check this page periodically for updates.</p>

		<h4>Contact Us</h4>
		<p>
			If you have any questions about this Privacy Policy, You can contact
			us by email: <a href="mailto:contact@nestandrest.com.np">contact@nestandrest.com.np</a>
		</p>
	</main>
